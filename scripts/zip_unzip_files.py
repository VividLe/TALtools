...
def args_parser():
    ...
    parser.add_argument('-ori_dir', default='/disk3/zt/code/2_TIP_rebuttal/4_ab_af/data/anet13/validation')
    parser.add_argument('-res_dir', default='/disk3/zt/code/2_TIP_rebuttal/4_ab_af/data/anet13/validation_upload')
    # zip files
    parser.add_argument('-num_feat_files', default=1000)
    parser.add_argument('-tmp_dir', default='/disk3/zt/code/2_TIP_rebuttal/4_ab_af/data/anet13/tmp')
    parser.add_argument('-num_proc', default=6)
    # unzip files
    parser.add_argument('-zip_dir', default='')
